...
$sql="SELECT material, description FROM material WHERE username='$username'";
...
if(strpos($new, $username) !== false){
    ...
    //   echo "</video>";
      ...
      ?>   
                <div name="material"> 
                    <a href="<?php echo $newone?>"><img src="../../Images/file.png" width="150" height="150"></a>
                </div>

                    
                        
                        <div class="materialDescription">
                            <a href="<?php echo $newone?>"><?php echo $description?></a>
